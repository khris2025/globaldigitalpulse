...
<div class="page-content">
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-12">
            <form action="{{ route('miningplans.store') }}" method="POST" enctype="multipart/form-data">
               @csrf
               <div class="mb-3">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                     ...
                     <form action="{{ route('miningplans.destroy', $plan->id) }}" method="POST" style="display:inline;">
                        @csrf
