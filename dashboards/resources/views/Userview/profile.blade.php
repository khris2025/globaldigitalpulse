                           ...
                           <div>
                              <div class="pb-3">
                                 <div class="row">
                                    <div class="col-lg-12">
                                       <div>
                                            @if (Auth::user()->account_type == 'joint')
                                              ...
                                              <div class="row">
                                                <div class="col-md-6">
                                                   <div class="mb-3">
                                                     ...
                                                     <input type="text" class="form-control" id="formrow-firstname-input" disabled value="{{ Auth::user()->fullname }}" >
                                                   </div>
                                                </div>
                                                <div class="col-md-6">
                                                   <div class="mb-3">
                                              ...
                                              @if (Auth::user()->account_type == 'joint')
                                                ...
                                                <div class="row">
                                                   <div class="col-md-6">
                                                      ...
                                                      <input type="text" class="form-control" id="formrow-firstname-input" disabled value="{{ Auth::user()->fullname2 }}" >
                                                      </div>
                                                   </div>
                                                   <div class="col-md-6">
                                                      <div class="mb-3">
                                                      <label class="form-label" for="formrow-email-input">User 2 Email</label>
                                                      <input type="text" class="form-control" id="formrow-email-input" disabled value="{{ Auth::user()->email2 }}">
                                                      </div>
                                                   </div>
                                                </div>
                                                <div class="row">
                                                   <div class="col-md-6">
                                                      ...
                                                      <input type="text" class="form-control" id="formrow-email-input" name="country" placeholder="Enter your Address" value="{{ Auth::user()->country2 }}" disabled>
                                                      </div>
                                                   </div>
                                                   <div class="col-md-6">
                                                      <div class="mb-3">
                                                      <label class="form-label" for="formrow-email-input">User 2 Gender</label>
                                                      <input type="text" class="form-control" id="formrow-lastname-input" name="gender"  value="{{ Auth::user()->gender2 }}" disabled>
                                                      </div>
                                                   </div>
                                                </div>
                                                <div class="row">
                                                   <div class="col-md-6">
                                                      ...
                                                      <input type="text" class="form-control" id="formrow-email-input" name="country" placeholder="Enter your Address" value="{{ Auth::user()->address2 }}" disabled>
                                                      </div>
                                                   </div>
                                                   <div class="col-md-6">
                                                      <div class="mb-3">
                                                      <label class="form-label" for="formrow-email-input">User 2 Phone Number</label>
                                                      <input type="text" class="form-control" id="formrow-lastname-input" name="gender"  value="{{ Auth::user()->phone_number2 }}" disabled>
                                                      </div>
                                                   </div>
                                                </div>
                                              @endif
