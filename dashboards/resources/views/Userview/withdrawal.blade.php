                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <h4 class="mb-3">$<span>{{ number_format(Auth::user()->walletbalance) }}</span></h4>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="text-nowrap">
                                ...
                                {{-- <button type="button" data-bs-toggle="modal" data-bs-target="#staticBackdropexpress" class="btn btn-soft-success waves-effect waves-light btn-rounded">
                                    <i class="bx bx-transfer-alt label-icon"></i> Withdraw Funds to External Crypto wallet (Express)
                                </button> --}}
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    ...
                                    <h4 class="mb-3">$<span>{{ number_format(Auth::user()->refbonus) }}</span></h4>
                                </div>
                                <div class="col-6">
                                        ...
                                        <table id="datatable" class="table nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    btn-outline-primary'; $buttonText = 'Attach Proof'; } @endphp
                                                    ...
                                                    <td style="font-size: 16px;" class="font-w400"> {{ $withdrawal->ETA }} </td>
                                                    ...
                                                    <td><a href="{{ route('use_express', ['id' => $withdrawal->id]) }}" class="btn btn-rounded btn-primary">Express</a></td>
