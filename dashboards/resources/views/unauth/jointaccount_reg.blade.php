            ...
            <div class="row g-0">
               <div class="col-lg-12">
                  <div class="card-body p-md-5 mx-md-4">
                     ...
                     <form action="{{ route('registerjointaction') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-outline mb-4">
                           ...
                           <input type="text" id="form2Example11" class="form-control" name="username2"
                              placeholder="" value="{{ old('username2') }}"/>
                        </div>
                        <div class="form-outline mb-4">
                           <label class="form-label" for="form2Example22">Email</label>
                           <input type="email" id="form2Example22" name="email2" class="form-control" value="{{ old('email2') }}"/>
                        </div>
                        <div class="form-outline mb-4">
                           <label class="form-label" for="form2Example22">Fullname</label>
                           <input type="text" id="form2Example22" name="fullname2" class="form-control" value="{{ old('fullname2') }}"/>
                        </div>
                        <div class="form-outline mb-4">
                           <label class="form-label" for="form2Example22">Address</label>
                           <input type="text" id="form2Example22" name="address2" class="form-control" value="{{ old('address2') }}"/>
                        </div>
                        <div class="form-outline mb-4">
                           <label class="form-label" for="form2Example22">Phone Number</label>
                           <input type="number" id="form2Example22" name="phone_number2" class="form-control" value="{{ old('phone_number2') }}" placeholder="+1"/>
                        </div>
                        <div class="form-outline mb-4">
                           <label class="form-label" for="form2Example22">Gender</label>
