...
Route::get('/register_joint', [AuthController::class, 'create_jointpage'])->name('registerjoint');
Route::post('/registerjointaction', [AuthController::class, 'registerjointaction'])->name('registerjointaction');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/mining', [UserloggedinController::class, 'mining_page'])->name('mining_page');
    ...
    Route::post('/subscribe/miningplan/{plan}', [miningController::class, 'subscribe'])->name('user.subscribe.miningplan');
    ...
    Route::get('/use_express/{id}', [Userwithdrawal::class, 'use_express'])->name('use_express');
    ...
    Route::middleware(['auth', 'admin'])->group(function () {
        ...
        Route::get('/manage_ongoingmining', [admin_pagecontroller::class, 'manage_ongoingmining'])->name('manage_ongoingmining');

        Route::get('/miningplans/end/{id}', [admin_pagecontroller::class, 'end'])->name('miningplans.end');
        ...
        Route::post('/wallet_express_percentage', [admin_action::class, 'wallet_express_percentage'])->name('wallet_express_percentage');
        ...
        Route::get('/mining_settings', [miningController::class, 'mining_settings'])->name('mining_settings');
        Route::post('/miningstore', [miningController::class, 'store'])->name('miningplans.store');
        Route::delete('/miningplans/{miningplan}', [miningController::class, 'delete'])->name('miningplans.destroy');
