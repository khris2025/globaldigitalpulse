         ...
         <div class="row">
            <div class="col-12">
               <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 class="mb-sm-0 font-size-18">KYC-Payment</h4>
                  <div class="page-title-right">
                     <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">User</a></li>
                        <li class="breadcrumb-item active">KYC-Payment</li>
                     </ol>
                  </div>
               </div>
            </div>
                  ...
                  <div class="card-body pb-0 text-center">
                     ...
                     <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex px-0 justify-content-between">
                           ...
                           <span class="mb-0"><?php echo e($kycData->transaction_id); ?></span>
                        </li>
                        <li class="list-group-item d-flex px-0 justify-content-between">
                           <strong>Date/Time</strong>
                           <span class="mb-0"><?php echo e($kycData->dateadd); ?></span>
                        </li>
                        <li class="list-group-item d-flex px-0 justify-content-between">
                           <strong>Amount to Pay</strong>
                           <span class="mb-0">$<?php echo e(number_format($kyc_amount)); ?></span>
                        </li>
                     </ul>
                  </div>
                           ...
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="text-center">
                                    ...
                                    <div class="mb-2" style="text-align: center; margin-top: 1%;" id="circle">   <img src="<?php echo e(url('storage/qr_images/' . $QRcode)); ?>" style="border-radius: 10%;  height: 150px;" alt="qrcode" />  </div>
                                    <br>
                                    <form action="<?php echo e(route('kyc_upload_proof')); ?>" method="post" enctype="multipart/form-data">
                                       <?php echo csrf_field(); ?>
                                       ...
                                       <?php if($kycData->status == 'unconfirmed' || $kycData->status == 'canceled'): ?>
                                          <div class="mb-4" style="text-align: center;" id="circle">
                                             <br>
                                             <?php if($kycData->proof): ?>
                                             <img id="blah" src="<?php echo e(url('storage/kyc_payment_proof/' . $kycData->proof)); ?>" style="border-radius: 10%;  height: 150px;" alt="Uploaded Image">
                                             <?php endif; ?>
                                          </div>
...
<?php echo $__env->make('Userview.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838997326/domains/trade.bright-waveholdinginc.com/public_html/NN/resources/views/Userview/kyc_payment.blade.php ENDPATH**/ ?>