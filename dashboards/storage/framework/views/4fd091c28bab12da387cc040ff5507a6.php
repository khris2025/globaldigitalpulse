             ...
             <div class="col-xl-6 col-sm-6 ">
                <div class="card card-coin">
                   <div class="card-body text-center">
                      ...
                      <div class="row">
                        <div class="col-md-8">
                            <input type="text" id="myInput" class="form-control" value="<?php echo e('https://dash.home.bright-waveholdinginc.com/register' . '?ref=' . Auth::user()->referral_code); ?>" readonly>
                        </div>
                        <div class="col-md-4">
