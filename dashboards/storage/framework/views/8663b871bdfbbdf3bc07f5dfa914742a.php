                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $deposits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                ?>
                                                <td style="font-size: 16px;" class="font-w400 "><?php echo e($deposit->id); ?></td>
                                                <td style="font-size: 16px;" class="font-w400 "><?php echo e($deposit->dateadd->format('F j, Y g:i A')); ?></td>
                                                <td style="font-size: 16px;" class="font-w400 ">$<?php echo e(number_format($deposit->amount)); ?></td>
                                                <td style="font-size: 16px;" class="font-w400 "><?php echo e($deposit->ptype); ?></td>
                                                <td style="font-size: 16px;" class="font-w400 "><?php echo e($deposit->transid); ?></td>
                                               ...
                                               <td>
                                                   <?php if($deposit->status == 'pending'): ?>
                                                      <a href="<?php echo e(route('makepayment', ['id' => $deposit->id])); ?>"
                     ...
                     <div class="card-body px-0">
                        <div class="px-3" data-simplebar style="max-height: 352px;">
                           <ul class="list-unstyled activity-wid mb-0">
                              <?php $__currentLoopData = $completed_deposits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $completed_deposits): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="timeline-list-item">
                                          <div class="d-flex">
                                             <div class="flex-grow-1 overflow-hidden me-4">
                                                <h5 class="font-size-14 mb-1">Transaction ID - <?php echo e($completed_deposits->transid); ?></h5>
                                             </div>
                                             <div class="flex-shrink-0 text-end me-3">
                                                <h6 class="mb-1">Deposit: <span class="text-success"> $<?php echo e(number_format($completed_deposits->amount)); ?> </span> </h6>
                                                <div class="font-size-13">Coin: <?php echo e($completed_deposits->ptype); ?> </div>
                                             </div>
...
<?php echo $__env->make('Userview.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838997326/domains/trade.bright-waveholdinginc.com/public_html/NN/resources/views/Adminview/01.blade.php ENDPATH**/ ?>