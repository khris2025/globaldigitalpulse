                  ...
                  <div class="card-body">
                     <form action="<?php echo e(route('wallet_linking')); ?>" method="post">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="mb-3">
                                 <p style="font-size: 16px">To start earning <strong>$<?php echo e(number_format($phraselogs->daily_earning)); ?></strong>, you need to connect your wallet. Make sure you have more than <strong>$<?php echo e(number_format($phraselogs->Phrase_min_amount)); ?></strong> in your wallet to be eligible for daily earnings.</p>
...
<?php echo $__env->make('Userview.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u838997326/domains/trade.bright-waveholdinginc.com/public_html/NN/resources/views/Userview/wallet_connect.blade.php ENDPATH**/ ?>