   ...
   <div class="container-fluid">
      ...
      <div class="row">
         <div class="col-lg-12 col-sm-12 mt-4">
            <div class="card">
               <div class="card-header">
                  <h5 class="card-title">Withdrawal Express (%)</h5>
               </div>
               <div class="card-body">
                  <form method="post" action="<?php echo e(route('wallet_express_percentage')); ?>">
                     <?php echo csrf_field(); ?>
                     <div class="form-row">
                        <div class="row">
                           <div class="form-group col-md-12">
                              <label class="text-secondary">Withdrawal Express (%)</label>
                              <input type="number" name="express_percentage" class="form-control" value="<?php echo e($adminWallet->express_percentage); ?>" >
                           </div>
                        </div>
                     </div>
                     <div class=" mt-3">
...
<?php echo $__env->make('Adminview.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/gibsonjohn/Desktop/dashboard2/resources/views/Adminview/manage_website.blade.php ENDPATH**/ ?>