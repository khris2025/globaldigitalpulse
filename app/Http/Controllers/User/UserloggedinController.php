...
use App\Models\Mining; // Assuming you have a Mining model for mining plans
use App\Models\SubscribedMiningPlan; // Assuming you have a model for subscribed mining plans
...
class UserloggedinController extends Controller
{
    ...
    public function mining_page(){
        ...
        $subscribedPlans = SubscribedMiningPlan::where('email', $userEmail)
            ->where('status', 'ongoing')
            ->get();
        $completedmining = SubscribedMiningPlan::where('email', $userEmail)
            ->where('status', 'completed')
            ->orderBy('created_at', 'desc')
            ->get();
        return view('Userview.Mining', compact('miningPlans', 'subscribedPlans', 'completedmining'));
    }
}
